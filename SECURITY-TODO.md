...
Items to address before enabling Stripe payments in production.
...
- [ ] Verify Stripe webhook signature validation in the Next.js route handler
- [ ] Confirm `STRIPE_WEBHOOK_SECRET` is set in production environment
