...
- A live connection keeps values and permissions current while the window is open.
...
Manage them with **Envpilot: Add Directory** and **Envpilot: Remove Directory**. Environments are picked per directory when you link or add it.
