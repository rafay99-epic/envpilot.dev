...
<Callout type="danger" title="Push never files approval requests">
  Denied keys are reported and skipped. To propose a brand-new variable for
  review, use [`envpilot request`](/cli/requests) — that is the path a reviewer
  can act on.
</Callout>
