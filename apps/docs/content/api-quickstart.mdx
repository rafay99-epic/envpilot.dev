...
A request outside a key's scope behaves the same as if the resource didn't exist — you'll get a `404`, never a `403`. This is deliberate: see [API Security](/api-security) for why.
