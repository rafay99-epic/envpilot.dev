...
- **Resources** — which resource types the key can read: `variables`, `accounts`, `projects`, `artifacts`, and optionally `requests` (the one write path — filing a variable request for a human to approve)
