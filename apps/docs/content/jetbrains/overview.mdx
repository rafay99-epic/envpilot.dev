...
- Requires the **JetBrains IDE Plugin** feature on your organization's plan. When an owner turns it off, linking stops and the tool window marks the organization `[JetBrains plugin disabled]`. See [Plans & limits](/limits/plans).
