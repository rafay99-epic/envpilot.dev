...
Then **Organization Settings → Integrations → Add manually**, pick the platform, paste the URL, and choose event groups. All webhook URLs — manual or OAuth-connected — are encrypted as credentials, and the UI only ever shows a masked preview.
