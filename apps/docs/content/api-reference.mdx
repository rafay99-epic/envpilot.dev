...
Unchanged legacy endpoint used by the [GitHub Action](/github-action) — pulls variables for a single project + environment service token. Kept for backward compatibility; new integrations should use `GET /v1/projects/{slug}/variables` instead.
