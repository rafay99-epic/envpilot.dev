    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        service.startSignIn { email, error ->
            ApplicationManager.getApplication().invokeLater {
                when {
                    error != null -> com.intellij.notification.NotificationGroupManager.getInstance()
                        .getNotificationGroup("dev.envpilot.notifications")
                        .createNotification("Envpilot sign-in failed: ${error.message}", com.intellij.notification.NotificationType.ERROR)
                        .notify(e.project)
                    email != null -> com.intellij.notification.NotificationGroupManager.getInstance()
                        .getNotificationGroup("dev.envpilot.notifications")
