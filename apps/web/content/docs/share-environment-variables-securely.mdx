...
[Envpilot](/) stores secrets AES-256-encrypted in an isolated vault, with [role-based access control](/docs/rbac) down to the individual variable. The day-to-day workflow looks like this:
...
For the full setup walkthrough, see [Getting Started](/docs/getting-started).
