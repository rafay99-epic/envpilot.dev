...
function HeadingAnchor({ id }: { id: string }) {
  return (
    <a
      href={`#${id}`}
      className="ml-2 font-mono text-green-500 opacity-0 transition-opacity group-hover:opacity-70 hover:!opacity-100"
...
export const docsComponents = {
  ...
  h1: (props: P<"h1">) => (
    <h1
      className="mb-4 font-sans text-3xl font-bold tracking-tight text-zinc-100 md:text-4xl"
      {...props}
    />
  ),
  ...
  h2: (props: P<"h2">) => {
    ...
    return (
      <h2
        id={id}
        className="group mb-4 mt-14 scroll-mt-24 border-b border-zinc-800/60 pb-2 font-sans text-xl font-semibold tracking-tight text-zinc-100 first:mt-0 md:text-2xl"
        {...props}
      >
        {props.children}
  ...
  h3: (props: P<"h3">) => {
    ...
    return (
      <h3
        id={id}
        className="group mb-3 mt-10 scroll-mt-24 font-sans text-lg font-semibold tracking-tight text-zinc-100"
        {...props}
      >
        {props.children}
        {id && <HeadingAnchor id={id} />}
  ...
  h4: (props: P<"h4">) => (
    <h4
      className="mb-2 mt-8 font-sans text-base font-semibold text-zinc-200"
      {...props}
    />
  ),
  ...
  a: (props: P<"a">) => (
    <a
      className="font-medium text-green-400 underline-offset-4 transition-colors hover:text-green-300 hover:underline"
      target={
  ...
  ul: (props: P<"ul">) => (
    <ul
      className="mb-5 space-y-2 pl-5 text-zinc-400 [&>li]:relative [&>li]:before:absolute [&>li]:before:-left-4 [&>li]:before:top-[0.6em] [&>li]:before:h-1.5 [&>li]:before:w-1.5 [&>li]:before:rounded-full [&>li]:before:bg-green-500/60"
      {...props}
    />
  ),
  ...
  ol: (props: P<"ol">) => (
    <ol
      className="mb-5 list-decimal space-y-2 pl-5 text-zinc-400 marker:font-mono marker:text-green-500/70"
      {...props}
    />
  ),
  ...
  code: (props: P<"code">) => {
    ...
    return (
      <code
        className="rounded border border-green-500/20 bg-green-500/10 px-1.5 py-0.5 font-mono text-[0.85em] text-green-300"
        {...props}
      />
    );
  },
  ...
  blockquote: (props: P<"blockquote">) => (
    <blockquote
      className="mb-5 rounded-r-lg border-l-2 border-green-500/50 bg-zinc-900/40 py-3 pl-4 pr-4 text-sm leading-relaxed text-zinc-400 [&>p:last-child]:mb-0"
      {...props}
    />
  ),
  ...
  hr: () => <hr className="my-10 border-zinc-800/60" />,

  // ── Tables ────────────────────────────────────────────────────────────

  table: (props: P<"table">) => (
    <div className="mb-6 overflow-x-auto rounded-xl border border-zinc-800 bg-zinc-900/40">
  ...
  th: (props: P<"th">) => (
    <th
      className="whitespace-nowrap px-4 py-3 text-left font-mono text-xs font-semibold tracking-wide text-zinc-300"
      {...props}
    />
  ),
  ...
  tr: (props: P<"tr">) => (
    <tr
      className="border-b border-zinc-800/50 transition-colors last:border-b-0 hover:bg-green-500/[0.03]"
      {...props}
    />
  ),
  ...
  td: (props: P<"td">) => (
    <td
      className="px-4 py-3 align-top text-sm leading-relaxed text-zinc-400"
      {...props}
    />
  ),
