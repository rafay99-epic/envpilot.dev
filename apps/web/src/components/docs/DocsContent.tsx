            ...
            <div className="space-y-4">
              ...
              <div className="rounded-lg border border-zinc-800 p-5">
                ...
                <p className="mt-2 text-sm text-zinc-400">
                  ...
                  file to the cloud. Calculates a diff and asks for confirmation
                  before pushing.
                </p>
                <table className="mt-3 w-full">
                  <tbody>
              ...
              <div className="rounded-lg border border-zinc-800 p-5">
                ...
                <p className="mt-2 text-sm text-zinc-400">
                  List organizations, projects, or variables. Values are masked
                  by default.
                </p>
        ...
        {active === "extension" && (
          <div className="space-y-8">
            ...
            <p className="text-lg text-zinc-400">
              ...
              variable sync directly in your editor. It supports multi-directory
              linking, WebSocket-based live updates, and automatic file cleanup
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-zinc-400">
                ...
                the VS Code extension marketplace, or install from the Settings
                &rarr; Integrations page in the web dashboard.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-5">
              ...
              <p className="mt-2 text-sm text-zinc-400">
                ...
                projects or environments. Each directory syncs independently to
                its own{" "}
                <code className="rounded bg-zinc-800 px-1 text-xs text-zinc-300">
                  .env
                </code>{" "}
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-5">
              ...
              <p className="mt-2 text-sm text-zinc-400">
                ...
                Team Leads and Admins can grant read or write access to specific
                variables, with optional expiration dates. When a Member needs a
                variable they don&apos;t have access to, they submit a request
