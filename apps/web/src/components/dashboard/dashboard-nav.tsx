...
export function DashboardNav() {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside
        className={`relative z-20 hidden shrink-0 border-r border-line bg-[#0f172a] transition-all duration-200 md:block ${
      ...
      {/* Mobile Header */}
      <div className="fixed inset-x-0 top-0 z-50 flex h-14 items-center justify-between border-b border-line bg-[#0f172a] px-4 md:hidden">
