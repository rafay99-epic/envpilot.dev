...
export default function GlassmorphismLanding() {
  ...
  const steps = [
    ...
    },
    {
      ...
      desc: "Set variables per environment — development, staging, production.",
    },
    {
      num: "03",
      title: "Invite Your Team",
      desc: "Add team members with granular per-variable permissions.",
    },
    {
      num: "04",
      title: "Sync Everywhere",
      desc: "CLI, VS Code extension, and CI/CD — always in sync.",
    },
  ];
        ...
        <section className="flex min-h-[90vh] items-center py-20">
          <div className="mx-auto max-w-6xl px-4 text-center">
            <motion.div initial="hidden" animate="visible" variants={stagger}>
              ...
              >
                Stop sharing API keys over Slack. Envpilot encrypts, manages,
                and syncs your environment variables across every team and
                environment.
              </motion.p>
          ...
          <div className="mx-auto max-w-6xl px-4">
            ...
            >
              ...
              <p className="mt-4 text-white/50">
                Enterprise-grade security, developer-friendly experience.
              </p>
            </motion.div>
            ...
            >
              {features.map((f) => (
                <GlassCard key={f.title}>
                  <div
                    className={`mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${f.gradient} text-white shadow-lg`}
                  >
                    {f.icon}
                  </div>
        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            {[
              {
                title: "Product",
                links: ["Features", "Pricing", "Changelog", "Wishlist"],
              },
              {
                title: "Resources",
