    ...
    <div className="min-h-screen bg-stone-50 text-stone-900 dark:bg-stone-950 dark:text-stone-100">
      ...
      <header className="border-b border-stone-200 bg-stone-50 dark:border-stone-800 dark:bg-stone-950">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          <Link
            href="/"
            className="text-xl font-serif font-bold italic tracking-tight"
          >
            Envpilot
          </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/sign-up"
              className="bg-stone-900 dark:bg-stone-100 px-4 py-2 text-sm font-medium text-white dark:text-stone-900 hover:bg-stone-800 dark:hover:bg-stone-200 transition-colors"
            >
              Get started
            </Link>
          </div>
      ...
      <main>
              ...
              >
                <div className="md:col-span-8">
                  ...
                  <h1 className="mt-6 font-serif text-5xl font-bold leading-[1.1] tracking-tight md:text-7xl lg:text-8xl">
                    Your team&apos;s secrets deserve better infrastructure
                  </h1>
                </div>
                <div className="flex flex-col justify-end md:col-span-4">
                  <p className="text-lg leading-relaxed text-stone-500 dark:text-stone-400">
                    Envpilot replaces insecure secret sharing with an encrypted
                    vault, granular access control, and tools that meet
          ...
          <div className="mx-auto max-w-4xl px-6 text-center">
            ...
            >
              <blockquote className="font-serif text-2xl font-normal italic leading-relaxed text-stone-600 dark:text-stone-400 md:text-3xl">
                &ldquo;The average enterprise rotates over 50,000 secrets per
                year. Most do it manually, over channels that were never
                designed for sensitive data.&rdquo;
              </blockquote>
        ...
        <section id="platform" className="py-20">
          <div className="mx-auto max-w-6xl px-6">
            ...
            >
              ...
              <motion.div
                variants={fadeIn}
                className="mt-12 grid gap-16 md:grid-cols-2"
              >
                {/* Left: Large feature */}
                <div>
                  ...
                  <p className="mt-6 text-lg leading-relaxed text-stone-500 dark:text-stone-400">
                    Whether your team works from the terminal, the IDE, or the
                    browser, Envpilot keeps every secret encrypted, versioned,
                    and access-controlled from a single platform.
                  </p>
                </div>
                ...
                <div className="space-y-8">
                  {[
                    ...
                    <div
                      key={f.title}
                      className="border-l-2 border-stone-300 pl-6 dark:border-stone-700"
                    >
              ...
              >
                ...
                <div className="md:col-span-7 md:pt-12">
                  <div className="space-y-8 text-lg leading-relaxed text-stone-500 dark:text-stone-400">
                    <p>
                      Every secret stored in Envpilot is encrypted using AES-256
                      via WorkOS Vault. The platform stores only vault
                      references — never the plaintext values themselves. Each
                      organization has cryptographic isolation through unique
                      key derivation.
                    </p>
                    <p>
                      Access control operates on two layers: organization-level
                      RBAC (Admin, Team Lead, Member) and variable-level
                      permissions with optional expiration dates. Members
                      can&apos;t create variables directly — they submit
                      requests that must be approved by a Team Lead or Admin.
                    </p>
                    <p>
                      Every action is logged. Forty-plus event types capture
                      reads, writes, permission changes, authentication
                      attempts, and more — complete with IP addresses, user
                      agents, and geographic location data. Export any time for
                      SOC 2 compliance.
                    </p>
                  </div>
                </div>
              ...
              {[
                {
                  ...
                  desc: "AES-256 encryption. Zero-knowledge architecture. Organization-scoped cryptographic isolation.",
                },
                {
                  title: "RBAC + Per-Variable",
                  desc: "Three-tier roles. Per-variable permissions with expiration. Request and approval workflow.",
                },
                {
                  title: "Audit Trail",
                  desc: "40+ action types. IP tracking. Geographic location. Date range filtering. SOC2 exports.",
                },
                {
                  title: "CLI Integration",
                  desc: "Pull, push, diff. Dry-run previews. Environment targeting. Browser-based SSO authentication.",
                },
                {
                  title: "IDE Extension",
                  desc: "WebSocket real-time sync. Multi-directory support. Automatic cleanup on access revocation.",
                },
                {
                  title: "Version History",
                  desc: "Complete variable history. Point-in-time rollback (admin-only). Change tracking per environment.",
                },
              ].map((f) => (
                <motion.div
                  key={f.title}
        ...
        <section
          id="enterprise"
          className="border-t border-stone-200 py-20 dark:border-stone-800"
        >
          <div className="mx-auto max-w-6xl px-6">
            <motion.div
              initial="hidden"
            ...
            >
              ...
              >
                <div>
                  ...
                  <p className="mt-6 text-lg leading-relaxed text-stone-500 dark:text-stone-400">
                    From startups deploying their first production environment
                    to enterprises managing thousands of secrets across dozens
                    of teams — Envpilot scales with your security requirements.
                  </p>
                  <Link
                    href="/sign-up"
                  ...
                  {[
                    {
                      ...
                      a: "Encrypted in WorkOS Vault using AES-256. We store vault references, never plaintext. Each org has cryptographic isolation.",
                    },
                    {
                      q: "What happens when someone leaves?",
                      a: "Revoke access instantly. The VS Code extension automatically removes synced .env files via WebSocket in seconds.",
                    },
                    {
                      q: "Can we audit who accessed what?",
                      a: "Yes. 40+ action types with IP, user agent, and geographic location. Filter and export for compliance.",
                    },
                  ].map((faq) => (
                    <motion.div
                      key={faq.q}
          ...
          <div className="mx-auto max-w-4xl px-6 text-center">
            ...
            >
              ...
              <div className="mt-8 flex items-center justify-center gap-4">
                <Link
                  href="/sign-up"
                  className="bg-stone-900 dark:bg-stone-100 px-6 py-3 text-sm font-medium text-white dark:text-stone-900 hover:bg-stone-800 dark:hover:bg-stone-200 transition-colors"
                >
                  Start free trial
                </Link>
                <Link
                  href="/sign-in"
                  className="border border-stone-300 dark:border-stone-700 px-6 py-3 text-sm text-stone-500 hover:border-stone-400 dark:hover:border-stone-600 transition-colors"
                >
                  Contact sales
                </Link>
              </div>
