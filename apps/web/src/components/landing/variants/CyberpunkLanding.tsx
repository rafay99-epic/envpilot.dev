...
export default function CyberpunkLanding() {
  ...
  const features = [
    {
      title: "ENCRYPTION",
      desc: "AES-256 vault encryption. Zero-knowledge. Your secrets are untouchable.",
      color: "cyan",
      borderColor: "border-l-cyan-500",
    },
    {
      title: "SSO AUTH",
      desc: "SAML/OIDC enterprise authentication. Multi-org workspaces.",
      color: "magenta",
      borderColor: "border-l-fuchsia-500",
    },
    {
      title: "ACCESS CTRL",
      desc: "Three-tier RBAC. Per-variable permissions. Principle of least privilege.",
      color: "violet",
      borderColor: "border-l-violet-500",
    },
    {
      title: "IDE SYNC",
      desc: "VS Code & Cursor extensions. Real-time .env sync. Zero friction.",
      color: "cyan",
      borderColor: "border-l-cyan-500",
    },
    {
      title: "CLI OPS",
      desc: "Pull, push, diff from terminal. CI/CD native. Pipeline-ready.",
      color: "green",
      borderColor: "border-l-green-500",
    },
    {
      title: "AUDIT LOG",
      desc: "Complete access trail. SOC2 exports. Full operational visibility.",
      color: "magenta",
      borderColor: "border-l-fuchsia-500",
    },
  ];
  ...
  const timeline = [
    {
      step: "01",
      title: "INSTALL",
      desc: "Deploy the CLI agent to your system",
      cmd: "npm i -g @envpilot/cli",
    },
    {
      step: "02",
      title: "AUTHENTICATE",
      desc: "Establish secure identity handshake",
      cmd: "envpilot login --sso",
    },
    {
      step: "03",
      title: "SYNCHRONIZE",
      desc: "Pull encrypted variables to local env",
      cmd: "envpilot pull --env prod",
    },
    {
      step: "04",
      title: "DEPLOY",
      desc: "Push changes across environments",
      cmd: "envpilot push --env staging",
    },
  ];
  ...
  return (
    <div className="relative min-h-screen bg-gray-950 text-gray-300">
      ...
      {/* Header */}
      <header
        className="fixed top-0 left-0 right-0 z-50 bg-gray-950/80 backdrop-blur-md"
        style={{ borderBottom: "1px solid rgba(6,182,212,0.2)" }}
      >
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4">
          <Link href="/" className="flex items-center gap-2">
            <div
              className="flex h-7 w-7 items-center justify-center rounded border border-cyan-500/30"
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/sign-in"
              className="text-[11px] uppercase tracking-wider text-gray-600 hover:text-cyan-400"
            >
              Access
            </Link>
        ...
        <section className="flex min-h-[90vh] items-center py-20">
          <div className="mx-auto max-w-6xl px-4">
            <motion.div initial="hidden" animate="visible" variants={stagger}>
              ...
              <motion.p
                variants={fadeInUp}
                className="mt-8 max-w-lg text-sm leading-relaxed text-gray-500"
              >
                Military-grade encryption for your environment variables.
                Role-based access control. CLI-native workflow. Zero compromise
                on security.
              </motion.p>
          ...
          <div className="mx-auto max-w-6xl px-4">
            ...
            >
              {[
                ...
                >
                  <NeonText
                    color={s.color as "cyan" | "magenta" | "violet" | "green"}
        ...
        <section id="systems" className="border-t border-gray-800/50 py-24">
          <div className="mx-auto max-w-6xl px-4">
            <motion.div
              ...
              variants={fadeInUp}
            >
              <p className="text-[11px] uppercase tracking-[0.3em] text-cyan-500/70">
                {"// SYSTEM MODULES"}
              </p>
                    ...
                    <div key={node.label} className="flex items-center gap-4">
                      <div className="text-center">
                        <div
                          ...
                          style={{
                            boxShadow: `0 0 10px ${node.color === "cyan" ? "rgba(6,182,212,0.2)" : node.color === "magenta" ? "rgba(217,70,239,0.2)" : node.color === "violet" ? "rgba(139,92,246,0.2)" : "rgba(34,197,94,0.2)"}`,
                          }}
                        >
                          <NeonText
                            color={
                      ...
                      {i < 3 && (
                        <div className="hidden items-center md:flex">
                          ...
                          <div
                            className="h-2 w-2 rounded-full bg-cyan-500/50"
                            style={{ animation: "neon-pulse 2s infinite" }}
                          />
              ...
              {timeline.map((t, i) => (
                ...
                >
                  ...
                  <div className="pb-8">
                    ...
                    <code className="mt-3 inline-block rounded border border-gray-800 bg-gray-900/80 px-3 py-1.5 font-mono text-xs text-cyan-400/70">
                      $ {t.cmd}
                    </code>
                  </div>
                </motion.div>
        ...
        <section id="intel" className="border-t border-gray-800/50 py-24">
          <div className="mx-auto max-w-5xl px-4">
            ...
            >
              ...
              >
                <h3
                  className="mb-4 text-sm font-bold uppercase tracking-wider text-red-400"
              ...
              >
                <h3
                  className="mb-4 text-sm font-bold uppercase tracking-wider text-cyan-400"
            ...
            >
              ...
              >
                <h2 className="text-3xl font-bold uppercase tracking-tight text-white md:text-4xl">
                  Initialize <NeonText color="cyan">Security</NeonText> Protocol
                </h2>
