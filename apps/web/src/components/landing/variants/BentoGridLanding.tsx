...
function MockTerminal({
  ...
  lines: { prefix?: string; cmd: string; output?: string }[];
}) {
  return (
      ...
      <div className="mt-3 space-y-2">
        {[
          ...
          >
            ...
            <span
              className={`rounded px-1.5 py-0.5 text-[8px] font-medium ${m.color}`}
            >
              {m.role}
            </span>
          </div>
      ...
      <div className="mt-3 space-y-2">
        {[
          ...
          >
            <div className="flex items-center gap-2">
              <div
                className={`h-1.5 w-1.5 rounded-full ${log.icon.replace("text-", "bg-")}`}
              />
      ...
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-zinc-800/50 bg-black/80 backdrop-blur-xl">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/sign-up"
              className="rounded-lg bg-white px-3.5 py-1.5 text-xs font-medium text-black hover:bg-zinc-200 transition-colors"
            >
              Get Started
            </Link>
          </div>
        ...
        <section className="py-24 md:py-32">
          <div className="mx-auto max-w-6xl px-4">
            ...
            >
              <motion.div
                variants={fadeIn}
                className="mb-4 inline-flex items-center gap-2 rounded-full border border-zinc-800 bg-zinc-900 px-3 py-1 text-xs text-zinc-400"
              >
              ...
              <motion.p
                variants={fadeIn}
                className="mx-auto mt-5 max-w-xl text-base text-zinc-500"
              >
                Encrypted vault. Role-based access. CLI + IDE sync. One platform
                for every secret your team needs.
              </motion.p>
              ...
              >
                ...
                <Link
                  href="#features"
                  className="rounded-lg border border-zinc-800 px-5 py-2.5 text-sm text-zinc-400 hover:border-zinc-700 hover:text-white transition-colors"
                >
                  See Features
                </Link>
              </motion.div>
            ...
            >
              ...
              <BentoCard span="md:col-span-2" className="p-6">
                ...
                <p className="mt-1 text-sm text-zinc-500">
                  Manage variables, permissions, and audit logs from a unified
                  dashboard.
                </p>
                <div className="mt-4">
                  <MockDashboardCard />
              ...
              <BentoCard className="flex flex-col justify-between p-6">
                <div>
                  ...
                  <p className="mt-1 text-sm text-zinc-500">
                    AES-256 encryption via WorkOS Vault. Even we can&apos;t read
                    your secrets.
                  </p>
                </div>
              ...
              <BentoCard className="p-6">
                ...
                <p className="mt-1 text-sm text-zinc-500">
                  Pull, push, diff. Preview changes before applying.
                </p>
                <div className="mt-4">
                  <MockTerminal
                    lines={[
                      ...
                      {
                        prefix: "~",
                        cmd: "API_RATE_LIMIT (changed: 100 → 500)",
                      },
                    ]}
                  />
                </div>
              ...
              <BentoCard span="md:col-span-2" className="p-6">
                <div className="grid gap-4 md:grid-cols-2">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-zinc-500">
                      Three-tier RBAC: Admin, Team Lead, Member. Per-variable
                      permissions with optional expiration dates. Members submit
                    ...
                    <div className="mt-4 space-y-2">
                      {[
                        {
                          role: "Admin",
                          desc: "Full access + rollback + permission management",
                        },
                        {
                          role: "Team Lead",
                          desc: "Manage projects, variables, and team access",
                        },
                        {
                          role: "Member",
                          desc: "Read-only. Must request variable access",
                        },
                      ].map((r) => (
                        <div
                          key={r.role}
                          className="rounded-lg border border-zinc-800/50 bg-zinc-800/20 px-3 py-2"
                        >
              ...
              <BentoCard className="p-6">
                ...
                <p className="mt-1 text-sm text-zinc-500">
                  Real-time sync via WebSocket. Multi-directory support. Instant
                  revocation.
                </p>
                <div className="mt-4 rounded-lg border border-zinc-800 bg-black/40 p-3 text-xs">
                  <div className="flex items-center gap-2 border-b border-zinc-800 pb-2">
                    ...
                    <span className="ml-auto rounded bg-emerald-500/10 px-1 text-[9px] text-emerald-400">
                      synced
                    </span>
                  </div>
                  <div className="mt-2 space-y-1 text-[10px]">
                    ...
                    <p className="text-zinc-500">
                      packages/sdk/.env{" "}
                      <span className="text-zinc-600">← staging</span>
                    </p>
                  </div>
                </div>
              </BentoCard>
              ...
              <BentoCard span="md:col-span-2" className="p-6">
                <div className="grid gap-4 md:grid-cols-2">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-zinc-500">
                      40+ action types tracked. IP addresses, user agents,
                      geographic location. Filter by category, date range, user.
                      SOC2-ready exports.
                    </p>
                  </div>
                  <div>
              ...
              <BentoCard className="p-6">
                ...
                <p className="mt-1 text-sm text-zinc-500">
                  Members submit variable requests. Admins review and approve.
                  Perfect for regulated teams.
                </p>
                <div className="mt-4 space-y-2">
                  <div className="rounded-lg border border-amber-500/20 bg-amber-500/5 px-3 py-2">
                    ...
                    <p className="mt-1 text-[10px] text-zinc-500">
                      Requested by Carol &middot; 5m ago
                    </p>
                  </div>
                  <div className="rounded-lg border border-emerald-500/20 bg-emerald-500/5 px-3 py-2">
                    ...
                    <p className="mt-1 text-[10px] text-zinc-500">
                      Approved by Alice &middot; 1h ago
                    </p>
                  </div>
                </div>
              </BentoCard>
          ...
          <div className="mx-auto max-w-2xl px-4 text-center">
            ...
            >
              ...
              <div className="mt-8 flex items-center justify-center gap-3">
                ...
                <Link
                  href="/sign-in"
                  className="rounded-lg border border-zinc-800 px-6 py-2.5 text-sm text-zinc-400 hover:border-zinc-700 transition-colors"
                >
                  Contact Sales
                </Link>
              </div>
