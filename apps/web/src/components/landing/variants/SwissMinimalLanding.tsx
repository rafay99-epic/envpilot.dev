  ...
  const features = [
    {
      ...
      desc: "Military-grade encryption at rest and in transit",
    },
    {
      title: "SAML & OIDC SSO",
      desc: "Enterprise authentication for your organization",
    },
    {
      title: "Per-Variable ACLs",
      desc: "Granular permissions down to individual secrets",
    },
    {
      title: "VS Code Extension",
      desc: "Real-time .env sync without leaving your editor",
    },
    {
      title: "CLI Pipeline",
      desc: "Pull, push, diff from terminal and CI/CD systems",
    },
    {
      title: "Audit Exports",
      desc: "Complete access logs for compliance requirements",
    },
  ];
  ...
  const steps = [
    {
      num: "01",
      title: "Install",
      desc: "One command to add the CLI or extension",
    },
    {
      num: "02",
      title: "Authenticate",
      desc: "SSO login with your organization",
    },
  ...
  return (
    <div className="min-h-screen bg-white text-black dark:bg-black dark:text-white">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-zinc-200 bg-white/90 backdrop-blur-sm dark:border-zinc-800 dark:bg-black/90">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-6">
            <Link
              href="/sign-in"
              className="text-xs font-light uppercase tracking-[0.2em] text-zinc-500 hover:text-black dark:hover:text-white"
            >
              Sign In
            </Link>
            <Link
              href="/sign-up"
              className="text-xs font-light uppercase tracking-[0.2em] text-red-600 hover:text-red-700"
            >
              Get Started &rarr;
            </Link>
          </div>
      ...
      <main className="pt-14">
        ...
        <section className="flex min-h-[85vh] items-center py-32 md:py-40">
          <div className="mx-auto max-w-6xl px-6">
            <motion.div initial="hidden" animate="visible" variants={stagger}>
              ...
              <motion.div
                variants={fadeIn}
                className="mt-2 h-px w-16 bg-red-600"
              />
        ...
        <section
          id="process"
          className="border-t border-zinc-200 bg-zinc-50 py-24 dark:border-zinc-800 dark:bg-zinc-950"
        >
          <div className="mx-auto max-w-6xl px-6">
            <motion.div
              initial="hidden"
          ...
          <div className="mx-auto max-w-4xl px-6 text-center">
            ...
            >
              <p className="text-2xl font-extralight italic leading-relaxed tracking-tight text-zinc-600 dark:text-zinc-400 md:text-3xl">
                &ldquo;The best security is the kind you don&apos;t have to
                think about.&rdquo;
              </p>
