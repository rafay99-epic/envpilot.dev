...
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      if (labelFormatter) {
        return (
          <div className={cn("font-medium font-mono", labelClassName)}>
...
function getPayloadConfigFromPayload(
  ...
  if (
    ...
    // Try dataKey
    if ("dataKey" in (payload as Record<string, unknown>)) {
      configLabelKey = (payload as Record<string, unknown>).dataKey as string;
    }
  }
