...
import { GlowCard, Stagger, StaggerItem } from "@/components/marketing";
import type { BlogPostMeta } from "@/lib/blog/schema";
...
/**
 * Rough reading-time estimate based on description length.
 * Full content parsing would be more accurate but this keeps things fast.
 */
          ...
          <div className="relative overflow-hidden rounded-2xl border border-zinc-800/80 bg-gradient-to-br from-zinc-900/80 via-zinc-900/40 to-zinc-950/80 p-6 transition-all duration-300 hover:border-green-500/30 hover:shadow-[0_0_32px_rgba(34,197,94,0.06)] sm:p-8">
            ...
            <div className="relative">
              ...
              <div className="mb-4 flex flex-wrap items-center gap-3">
                ...
                <span className="font-mono text-[11px] text-zinc-600">
                  {estimateReadingTime(featured.description)}
                </span>
              </div>
