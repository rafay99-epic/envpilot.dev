// Legacy-role compatibility layer for already-installed CLI builds.
//
// Old CLI builds hardcode the pre-migration role strings (org: admin /
...
//
// NOTE: apps/web/src/app/api/extension/_lib/legacy-roles.ts is an identical
// copy for the extension routes — keep the two files in sync.
...
export interface ResolvedLegacyRoles {
   ...
   * the caller's role is not developer / has no assignment. New CLIs use this
   * to know production or other envs may have been withheld.
   */
