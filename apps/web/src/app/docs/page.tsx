...
function CommandRow({ cmd, desc }: { cmd: string; desc: string }) {
  return (
    <tr className="border-b border-zinc-800/50">
      <td className="w-[45%] px-4 py-3 align-top font-mono text-sm text-emerald-400">
        {cmd}
      </td>
  ...
  return (
    <tr className="border-b border-zinc-800/50">
      ...
      <td className="py-2 text-sm text-zinc-400">
        {desc}
        {def && (
          <span className="ml-2 text-xs text-zinc-600">(default: {def})</span>
        )}
      </td>
    </tr>
  );
      ...
      <header className="sticky top-0 z-50 border-b border-zinc-800 bg-zinc-950/90 backdrop-blur-md">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/sign-up"
              className="rounded-md bg-white px-3 py-1.5 text-xs font-medium text-zinc-900 hover:bg-zinc-200 transition-colors"
            >
              Get Started
            </Link>
          </div>
        ...
        <main className="min-w-0 flex-1">
          ...
          {active === "getting-started" && (
            <div className="space-y-8">
              ...
              <p className="text-lg text-zinc-400">
                Envpilot helps your team manage environment variables securely.
                Instead of sharing{" "}
                <code className="rounded bg-zinc-800 px-1.5 py-0.5 text-sm text-zinc-300">
                  .env
                </code>{" "}
                files over Slack or email, secrets are stored in an encrypted
                vault with granular access control.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <p className="mb-2 text-sm text-zinc-400">
                      2. Authenticate via browser-based SSO
                    </p>
                  ...
                  <div>
                    <p className="mb-2 text-sm text-zinc-400">
                      4. Pull your environment variables
                    </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-zinc-500">
                        Pull, push, and manage from your terminal
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-zinc-500">
                        Real-time sync inside your editor
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-zinc-500">
                        Full management UI in the browser
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-lg border border-zinc-800 p-5">
                  ...
                  <p className="mt-2 text-sm text-zinc-400">
                    Authenticate with Envpilot via browser-based SSO. Opens your
                ...
                <div className="rounded-lg border border-zinc-800 p-5">
                  ...
                  <p className="mt-2 text-sm text-zinc-400">
                    Initialize Envpilot in the current directory. Links your
                    project and environment, creates a{" "}
                    <code className="rounded bg-zinc-800 px-1 text-xs text-zinc-300">
                      .envpilot
                    </code>{" "}
                    config file, and adds{" "}
                    <code className="rounded bg-zinc-800 px-1 text-xs text-zinc-300">
                      .env
                    </code>{" "}
                    to your{" "}
                ...
                <div className="rounded-lg border border-zinc-800 p-5">
                  ...
                  <p className="mt-2 text-sm text-zinc-400">
                    Download environment variables to a local{" "}
                    <code className="rounded bg-zinc-800 px-1 text-xs text-zinc-300">
                      .env
                    </code>{" "}
                    file. Shows a diff of changes before writing.
                  </p>
                  <table className="mt-3 w-full">
                    <tbody>
                      <FlagRow
                ...
                <div className="rounded-lg border border-zinc-800 p-5">
                  ...
                  <p className="mt-2 text-sm text-zinc-400">
                    ...
                    file to the cloud. Calculates a diff and asks for
                  ...
                  <table className="mt-3 w-full">
                    <tbody>
                      ...
                      <FlagRow
                        flag="--merge"
                        desc="Merge with existing variables (default)"
                      />
                      <FlagRow
                        flag="--replace"
                        desc="Replace all existing variables"
                      />
                      <FlagRow
                        flag="--dry-run"
                        desc="Preview changes without pushing"
                      />
                ...
                <div className="rounded-lg border border-zinc-800 p-5">
                  ...
                  <p className="mt-2 text-sm text-zinc-400">
                    List organizations, projects, or variables. Values are
                    masked by default.
                  </p>
                  <div className="mt-2 text-xs text-zinc-500">
                    Resources: <code className="text-zinc-400">projects</code>{" "}
                    (default),{" "}
                    <code className="text-zinc-400">organizations</code>,{" "}
                    <code className="text-zinc-400">variables</code>
                  </div>
                  <table className="mt-3 w-full">
                    <tbody>
                      <FlagRow
                      ...
                      <FlagRow
                        flag="-e, --env <environment>"
                        desc="Environment filter"
                      />
                      <FlagRow
                        flag="--show-values"
                        desc="Show actual values (masked by default)"
                      />
                ...
                <div className="rounded-lg border border-zinc-800 p-5">
                  <div className="flex items-center gap-2">
                    ...
                    <h4 className="font-mono text-sm font-semibold text-white">
                      envpilot switch [target]
                    </h4>
                  </div>
                  <p className="mt-2 text-sm text-zinc-400">
                    Switch active project, organization, or environment. Without
                    arguments, opens interactive mode.
                  </p>
                  <table className="mt-3 w-full">
                    <tbody>
                      <FlagRow
                ...
                <div className="rounded-lg border border-zinc-800 p-5">
                  ...
                  <div className="mt-2 text-xs text-zinc-500">
                    Actions: <code className="text-zinc-400">list</code>{" "}
                    (default), <code className="text-zinc-400">get</code>,{" "}
                    <code className="text-zinc-400">set</code>,{" "}
                    <code className="text-zinc-400">path</code>,{" "}
                    <code className="text-zinc-400">reset</code>
                  </div>
                </div>
          ...
          {active === "extension" && (
            <div className="space-y-8">
              ...
              <p className="text-lg text-zinc-400">
                The Envpilot VS Code extension provides real-time environment
                variable sync directly in your editor. It supports
                multi-directory linking, WebSocket-based live updates, and
                automatic file cleanup on access revocation.
              </p>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-zinc-400">
                  Search for <strong className="text-white">Envpilot</strong> in
                  the VS Code extension marketplace, or install from the
                  Settings &rarr; Integrations page in the web dashboard.
                </p>
              </div>
                  ...
                  <table className="w-full table-fixed">
                    <thead>
                      <tr className="border-b border-zinc-800 bg-zinc-900/50">
                        <th className="w-[45%] px-4 py-2.5 text-left text-xs font-medium text-zinc-400">
                          Command
                        </th>
                    ...
                    <tbody className="divide-y divide-zinc-800/50">
                      <CommandRow
                        cmd="Envpilot: Sign In"
                        desc="Authenticate via browser-based OAuth"
                      />
                      <CommandRow
                        cmd="Envpilot: Sign Out"
                        desc="Log out and clear local session"
                      />
                      <CommandRow
                        cmd="Envpilot: Link Project"
                        desc="Link a project to the current workspace"
                      />
                      <CommandRow
                        cmd="Envpilot: Unlink Project"
                        desc="Remove project link from workspace"
                      />
                      <CommandRow
                        cmd="Envpilot: Pull Variables"
                        desc="Manually sync variables from cloud"
                      />
                      <CommandRow
                        cmd="Envpilot: Add Directory"
                        desc="Add a directory to a linked project"
                      />
                      <CommandRow
                        cmd="Envpilot: Remove Directory"
                        desc="Remove a directory from project sync"
                      />
                      <CommandRow
                        cmd="Envpilot: Select Environments"
                        desc="Choose which environments to sync"
                      />
                      <CommandRow
                        cmd="Envpilot: Request Variable"
                        desc="Submit a variable request (members)"
                      />
                      <CommandRow
                        cmd="Envpilot: Open Dashboard"
                        desc="Open web dashboard in browser"
                      />
                    </tbody>
                  </table>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="overflow-hidden rounded-lg border border-zinc-800">
                  <table className="w-full table-fixed">
                    ...
                    <tbody className="divide-y divide-zinc-800/50">
                      <CommandRow
                        cmd="envpilot.autoSync"
                        desc="Automatically sync on workspace open"
                      />
                      <CommandRow
                        cmd="envpilot.syncInterval"
                        desc="Permission check interval (60-3600s)"
                      />
                      <CommandRow
                        cmd="envpilot.targetFile"
                        desc="Default target file (e.g., .env.local)"
                      />
                      <CommandRow
                        cmd="envpilot.environment"
                        desc="Default environment (development, staging, production)"
                      />
                      <CommandRow
                        cmd="envpilot.preventCopyOnRevoke"
                        desc="Delete synced files when permissions are revoked"
                      />
                      <CommandRow
                        cmd="envpilot.defaultConflictResolution"
                        desc="Strategy: prompt, overwrite, backup, merge, skip"
                      />
                      <CommandRow
                        cmd="envpilot.enableMultiDirectorySync"
                        desc="Enable multi-directory linking"
                      />
                    </tbody>
                  </table>
                </div>
              ...
              <div className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-5">
                ...
                <p className="mt-2 text-sm text-zinc-400">
                  Link multiple directories in the same workspace to different
                  projects or environments. Each directory syncs independently
                  to its own{" "}
                  <code className="rounded bg-zinc-800 px-1 text-xs text-zinc-300">
                    .env
                  </code>{" "}
...
└── packages/sdk/.env      ← staging`}</CodeBlock>
          ...
          {active === "web-portal" && (
            <div className="space-y-8">
              ...
              <p className="text-lg text-zinc-400">
                The web dashboard is your central management interface for
                projects, variables, team members, and audit logs.
              </p>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={feature.title}
                    className="flex gap-4 rounded-lg border border-zinc-800 p-5"
                  >
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div
                    key={item.title}
                    className="flex gap-4 rounded-lg border border-zinc-800 bg-zinc-900/30 p-5"
                  >
          ...
          {active === "rbac" && (
            <div className="space-y-8">
              ...
              <p className="text-lg text-zinc-400">
                Envpilot uses a three-tier role-based access control system
                combined with per-variable permissions for fine-grained control.
              </p>
              ...
              <div className="space-y-4">
                {[
                  ...
                  >
                    <span
                      className={`inline-flex rounded-full border px-3 py-1 text-xs font-semibold ${r.color}`}
                    >
                      {r.role}
                    </span>
              ...
              <div className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-5">
                ...
                <p className="mt-2 text-sm text-zinc-400">
                  Beyond roles, access can be granted on individual variables.
                  Team Leads and Admins can grant read or write access to
                  specific variables, with optional expiration dates. When a
                  Member needs a variable they don&apos;t have access to, they
                  submit a request that must be approved.
                </p>
              </div>
            </div>
          )}
