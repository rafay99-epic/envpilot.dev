          ...
          {isNotFound ? (
            <>
              <p className="text-red-400">
                ERROR: Invitation invalid [exit code 1]
              </p>
              <p className="mt-2 text-zinc-400">
                This invitation doesn&apos;t exist, has expired, or has already
                been used.
              </p>
            </>
          ) : (
            <>
              <p className="text-red-400">
                ERROR: Failed to load invitation [exit code 1]
              </p>
              <p className="mt-2 text-zinc-400">
                There was an error loading this invitation. Please try again.
              </p>
            </>
          )}
