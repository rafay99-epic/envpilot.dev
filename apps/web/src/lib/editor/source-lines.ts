 ...
 *
 * Ported from wryte.xyz (apps/web/src/features/editor/lib/source-lines.ts).
 * Pure string/AST work with no wryte dependencies — kept verbatim so fixes
 * can be diffed against the original.
 */
