...
<Mermaid name="the-mobile-app-that-never-shipped-composition" />
...
<Mermaid name="the-mobile-app-that-never-shipped-two-auths" />
...
<Mermaid name="the-mobile-app-that-never-shipped-timeline" />
