...
So we built the JetBrains plugin. It is live on the [JetBrains Marketplace](https://plugins.jetbrains.com/plugin/33346-envpilot) today, and it runs on IntelliJ IDEA, Android Studio, PyCharm, GoLand, WebStorm, Rider and every other IDE on the IntelliJ platform, 2025.1 and newer.
...
Install from the [Marketplace](https://plugins.jetbrains.com/plugin/33346-envpilot) or via **Settings → Plugins → Marketplace → search Envpilot**. Sign in, link a directory, pull. If your team already uses Envpilot, your projects and permissions are already there waiting.
