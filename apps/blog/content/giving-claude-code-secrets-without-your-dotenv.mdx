...
Cursor, Claude Desktop, or any MCP client work the same way — it's a standard Streamable HTTP server with a bearer token ([client setup docs](https://docs.envpilot.dev/mcp-server)).
