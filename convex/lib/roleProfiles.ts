...
export const SEEDED_CUSTOM_PROFILES: Record<string, RoleProfile> = {
  editor: {
    ...
    displayName: "Editor",
    description:
      "Creates and edits variables and accounts in assigned projects; may share documentation with teammates but holds no member, permission, approval, or secret-sharing powers",
    color: "teal",
    level: 50,
    isSystem: false,
    capabilities: caps([
