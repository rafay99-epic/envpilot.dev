...
There are some important skills defined in the .Codex file or .agent folders . Use them to enhance your work and make sure that the code you write is up to quality standard.
